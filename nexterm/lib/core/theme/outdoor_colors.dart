...
class OutdoorColors {
  ...
  static const Color accentDim = Color(0x265CB85C);
  static const Color accentGlow = Color(0x4D5CB85C);

  // Dark mode
  static const Color darkBg = Color(0xFF0D1117);
  static const Color darkBgElevated = Color(0xFF161B22);
  static const Color darkSurface = Color(0xC7161B22);
  ...
  static const Color darkBorder = Color(0x9930363D);
  static const Color darkNavBg = Color(0xB80D1117);
  static const Color darkCardBg = Color(0xA6161B22);
  ...
  static const Color lightSurface = Color(0xC7FFFFFF);
  ...
  static const Color lightNavBg = Color(0xB8F5F0E6);
  static const Color lightCardBg = Color(0xA6FFFFFF);
